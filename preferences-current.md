...
- Never ask the user to paste API keys, credentials, or sensitive values.
...
4. State understanding of each active workstream
5. Ask which workstream and task to start with
6. Do NOT begin building or drafting anything until asked
...
- Live at: https://baker-legal.vercel.app/api/search
- GitHub: github.com/davidkbaker/baker-legal (private repo)
- Currently unprotected — add password protection in next session
...
Last updated: April 28, 2026. Version 1.1. Deprecates v1.0.*
